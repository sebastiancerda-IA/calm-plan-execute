...
import { LogOut, Leaf, PanelLeft } from 'lucide-react';
      ...
      <div className="flex items-center gap-3 min-w-0">
        {showMenuButton && (
          <button
            type="button"
            onClick={onMenuClick}
            className="inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:text-foreground hover:bg-sidebar-accent"
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="font-semibold text-foreground text-sm tracking-tight hidden sm:inline truncate">La Orquesta IDMA</span>
        </div>
        <span className="text-[10px] font-mono bg-idma-green/15 text-idma-green-light px-1.5 py-0.5 rounded border border-idma-green/20 shrink-0">v4.2</span>
      </div>
